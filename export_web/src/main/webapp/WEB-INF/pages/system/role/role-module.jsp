...
<SCRIPT type="text/javascript">
    ...
    $(function () {
        ...
        <%--treeObj = $.fn.zTree.init($("#treeDemo"), setting, ${modules});--%>
        // 2.准备数据
        $.ajax({
            type:'post',
            url:'/system/module/getZtreeNodes.do',
    ...
    function submitCheckedNodes(){
        ...
        for (var i=0;i<checked.length;i++){
            nodeIds += checked[i]["id"]+",";
        }
        nodeIds.substring(0,nodeIds.length-1);
        $("#moudlesId").val(nodeIds);
